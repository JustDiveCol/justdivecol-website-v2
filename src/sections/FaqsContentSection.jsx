...
import { faqStagger, faqFadeUp, chevronToggle, sectionFadeInUp } from '../hooks/animations';
...
const FaqsContentSection = ({ faqsData, translationNS }) => {
  ...
  return (
    <section className="py-8 bg-brand-neutral rounded-2xl">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {faqsData.faqs.map((faqSection) => (
            ...
            >
              ...
              <h3 className="heading-4 font-bold text-brand-primary-dark mb-6 text-left">
                ...
                {faqSection.faqs.map(
                  (
                    ...
                    >
                      ...
                      >
                        <span className="text-base-sm">{t(faq.questionKey)}</span>
                        {shouldReduce ? (
                        ...
                        {openFaqId === faq.id &&
                          (shouldReduce ? (
                            ...
                            <motion.div
                              ...
                              exit={{ opacity: 0 }}
                            >
                              <p className="text-base-xs">{t(faq.answerKey)}</p>
                            </motion.div>
                          ))}
                      </AnimatePresence>
                    </motion.div>
