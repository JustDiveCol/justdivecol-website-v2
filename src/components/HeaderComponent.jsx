      ...
      <div className={`group relative ${heightClass}`}>
        ...
        >
          ...
          <div className="relative z-10 p-4 select-text">
            <h1 className="heading-2 font-extrabold uppercase drop-shadow-xl opacity-90">
              {t(titleKey)}
            </h1>
            <p className="text-subtitle-sm mt-2 max-w-3xl mx-auto text-brand-neutral drop-shadow-md opacity-80">
              {t(subtitleKey)}
            </p>
          </div>
          ...
          {/* Complementary Logo */}
          {complementaryLogo && (
            <div className="absolute top-4 right-4 z-20 drop-shadow-md opacity-70">
              <img
