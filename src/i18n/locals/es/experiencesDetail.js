export default {
  ...
  // --- Header content ---
  expSmHeaderTitle: 'Tu aventura submarina comienza aquí: ¡Certifícate en Santa Marta!',
  expSmHeaderSubtitle:
  ...
  // --- Description block ---
  expSmDescTitle: 'Donde nace un nuevo explorador del mundo azul',

  expSmDescP1:
    'Imagina tu primera respiración bajo el agua, no solo en cualquier lugar, sino en las vibrantes y cristalinas aguas del Caribe colombiano, con la cautivadora ciudad de Santa Marta como base. Esta experiencia ha sido meticulosamente diseñada para que, desde cero, te sumerjas con total confianza. Te guiaremos paso a paso a través de las diversas y protegidas bahías de la región, un verdadero paraíso submarino que espera ser descubierto por ti. ¡La aventura de tu vida te aguarda!',
  expSmDescP2:
  ...
  expSmDetailLabel1: 'Inmersiones incluidas',
  expSmDetailValue1: '5 en Aguas Confinadas + 4 en Aguas Abiertas',

  expSmDetailLabel2: 'Nivel mínimo requerido',
  expSmDetailValue2: 'Ninguno (¡Solo necesitas ganas de explorar y un espíritu aventurero!)',

  expSmDetailLabel3: 'Edad mínima',
  expSmDetailValue3: '10 años (se aplican condiciones especiales para menores)',

  // --- Itinerary ---
  expSmItineraryDay1Title: 'Día 1: Llegada y fundamentos en aguas confinadas',
  expSmItineraryDay1Desc:
  ...
  expSmItineraryDay2Title: 'Día 2: ¡Al mar! Tus primeras inmersiones en aguas abiertas',
  expSmItineraryDay2Desc:
  ...
  expSmItineraryDay3Title: 'Día 3: Completando tu certificación y celebración',
  expSmItineraryDay3Desc:
  ...
  expSmItineraryDay4Title: 'Día 4: Despedida de un nuevo explorador submarino',
  expSmItineraryDay4Desc:
  ...
  expSmIncludeItem2:
    'Plan de alimentación completo durante la estadía: deliciosas cenas (3), energizantes desayunos (3) y snacks diarios para recargar energías.',
  expSmIncludeItem3:
    'Todos los traslados necesarios: aeropuerto-hotel-aeropuerto y a todas las emocionantes actividades de buceo/curso, para tu total comodidad.',
  expSmIncludeItem4:
    'Cubrimiento fotográfico profesional de tus inmersiones y momentos clave, para que atesores los recuerdos de tu aventura.',

  expSmNotIncludeItem1: 'Tiquetes aéreos nacionales o internacionales hacia y desde Santa Marta.',
  expSmNotIncludeItem2:
    'Bebidas alcohólicas, bebidas no especificadas y comidas adicionales fuera del plan de alimentación establecido.',
  expSmNotIncludeItem3:
    'Propinas para guías, instructores y personal de apoyo (opcional, pero siempre apreciadas).',
  expSmNotIncludeItem4:
    'Otros gastos personales no mencionados explícitamente en el plan de experiencia.',

  // === Santa Marta Septiembre 2025 ===
  expSmSep25PaymentPlanStep1Name: '50% (Fecha Límite: 15 de agosto de 2025)',
  expSmSep25PaymentPlanStep1Desc: 'Asegura tu cupo y recibe el material de estudio PADI.',

  expSmSep25PaymentPlanStep2Name: '25% (Fecha Límite: 5 de septiembre de 2025)',
  expSmSep25PaymentPlanStep2Desc: 'Cubre el siguiente abono para tu experiencia.',

  expSmSep25PaymentPlanStep3Name: '25% (Fecha Límite: 19 de septiembre de 2025)',
  expSmSep25PaymentPlanStep3Desc:
