// src/i18n/locals/es/divesites.js
export default {
  // ===== XYZ =====
  xyzSmName: '',
  xyzSmDescriptionP1: '',
  ...
  oceanoSmDescriptionP2:
    'Este sitio, cuyo nombre evoca su naturaleza de mar abierto, presenta una topografía submarina que desciende más allá de los 30 m / 100 ft, con formaciones rocosas que sirven de refugio y punto de reunión para la fauna mayor. Aunque la visibilidad puede ser variable debido a las condiciones oceánicas, la recompensa es la oportunidad de observar la majestuosidad de la vida pelágica en su elemento. Las inmersiones aquí requieren una planificación cuidadosa y experiencia en buceo con corrientes, pero la vivencia de ser uno con el vasto azul del Caribe colombiano es inolvidable. La entrada al sitio se realiza siempre desde embarcación.',
  // ----- PhotoCredits -----
  oceanoSmXXMainLogoAlt: 'Logo JustDiveCol',
  // oceanoSmXXComplementaryLogoAlt: '',
  // oceanoSmXXTextOverlay: '',
  oceanoSmXXPhotoCredit: 'Créditos: XYZ',

  // ===== Panelés (Dos Morritos) - PNN Tayrona =====
  panelesSmName: 'Panelés (Dos Morritos) - PNN Tayrona',
  panelesSmDescriptionP1:
    'Prepárate para una inmersión solo para los más audaces en Panelés (Dos Morritos), un desafiante sitio de buceo en el Parque Nacional Natural Tayrona, exclusivo para buzos muy experimentados y técnicos. Aquí te esperan pináculos rocosos azotados por corrientes oceánicas intensas, ofreciendo la increíble oportunidad de "volar" entre formaciones submarinas. Este es el epicentro de la vida pelágica, donde cardúmenes masivos y grandes peces cazadores te dejarán sin aliento. ¡Una aventura extrema que solo los buzos de élite pueden disfrutar al máximo!',
  panelesSmDescriptionP2:
    'Ubicado al costado occidental de Isla Aguja, este sitio se compone de un par de peñascos que apenas asoman en la superficie. La constante fuerza de las corrientes, lejos de ser un obstáculo, es una bendición que aporta una enorme cantidad de nutrientes, permitiendo que las rocas estén tapizadas por una infinidad de especies marinas, incluyendo corales, esponjas y anémonas, creando un ecosistema increíblemente denso. La visibilidad suele ser muy clara (15-25+ m / 50-80+ ft) y la profundidad va desde los 5-8 m / 15-25 ft en la cima de las rocas hasta más de 30 m / 100 ft en su base. Es el lugar ideal para la observación de jureles, pargos, barracudas de buen tamaño y ocasionales tortugas marinas, viviendo una experiencia dinámica e inolvidable.',
  // ----- PhotoCredits -----
  panelesSmXXMainLogoAlt: 'Logo JustDiveCol',
  // panelesSmXXComplementaryLogoAlt: '',
  // panelesSmXXTextOverlay: '',
  panelesSmXXPhotoCredit: 'Créditos: XYZ',

  // ===== Paraíso - PNN Tayrona =====
  paraisoSmName: 'Paraíso - PNN Tayrona',
  paraisoSmDescriptionP1:
    'Sumérgete en Paraíso, un verdadero refugio submarino en el corazón del Parque Nacional Natural Tayrona, que vive a la altura de su nombre. Este arrecife tranquilo y lleno de color es ideal para buzos de todos los niveles, desde principiantes hasta experimentados, ofreciendo aguas excepcionalmente calmadas, excelente visibilidad y una vibrante vida marina. ¡Es el escenario perfecto para una inmersión relajada y fotogénica, donde cada detalle te invita a la admiración!',
  paraisoSmDescriptionP2:
    'Con una profundidad máxima de aproximadamente 15 m / 50 ft, Paraíso se distingue por la ausencia de corrientes fuertes y una superficie serena, lo que garantiza una experiencia de buceo muy cómoda y segura. Aquí podrás apreciar una gran cantidad de corales duros y blandos en excelente estado de conservación, que tapizan el fondo rocoso y sirven de hogar a una abundante vida de peces tropicales y fascinante vida macro. Este "biodiversity hotspot" ofrece una experiencia de buceo serena y rica en descubrimientos en las cálidas aguas del Caribe colombiano, siendo un lugar predilecto para la fotografía submarina. La entrada al sitio se realiza cómodamente desde embarcación.',
  // ----- PhotoCredits -----
  paraisoSmXXMainLogoAlt: 'Logo JustDiveCol',
  // paraisoSmXXComplementaryLogoAlt: '',
  // paraisoSmXXTextOverlay: '',
  paraisoSmXXPhotoCredit: 'Créditos: XYZ',

  // ===== Paso del Angel - PNN Tayrona =====
  pasoDelAngelSmName: 'Paso del Ángel - PNN Tayrona',
  pasoDelAngelSmDescriptionP1:
    'Explora Paso del Ángel, una espectacular pendiente arrecifal en el Parque Nacional Natural Tayrona, considerada uno de los mejores sitios de buceo de la región. Aquí, la inmersión, que desciende hasta 40 m / 130 ft, es famosa por su excepcional biodiversidad, la abundante presencia de peces ángel y la emoción de un buceo a la deriva. Es el destino ideal para buzos intermedios y avanzados que buscan una aventura submarina vibrante y llena de vida.',
  pasoDelAngelSmDescriptionP2:
    'Este paraíso submarino, que comienza a solo 7 m / 25 ft de profundidad, está repleto de una increíble variedad de peces, esponjas y corales duros y blandos. Durante el buceo a la deriva, impulsado por corrientes que pueden ser de moderadas a fuertes, es común encontrarse con imponentes morenas verdes, langostas de gran tamaño e incluso el avistamiento ocasional de delicados caballitos de mar, convirtiéndolo en un lugar predilecto para la fotografía macro y de vida marina. Para los buzos más audaces, existe la emocionante opción de extender la aventura hacia "La Travesía" de Morrito Largo, un recorrido con corrientes aún más intensas reservado solo para expertos. Con visibilidad variable, pero siempre gratificante, Paso del Ángel ofrece una experiencia inolvidable en las cálidas aguas del Caribe colombiano, con acceso garantizado desde embarcación (lancha desde Taganga).',
  // ----- PhotoCredits -----
  pasoDelAngelSmXXMainLogoAlt: 'Logo JustDiveCol',
  // pasoDelAngelSmXXComplementaryLogoAlt: '',
  // pasoDelAngelSmXXTextOverlay: '',
  pasoDelAngelSmXXPhotoCredit: 'Créditos: XYZ',

  // ===== Playaca =====
  playacaSmName: 'Playaca',
  playacaSmDescriptionP1:
    'Descubre la serenidad de Playaca, un sitio de buceo tranquilo y poco profundo en el Parque Nacional Natural Tayrona, ideal para principiantes, buzos Open Water y entusiastas de la fotografía. Aquí te esperan arrecifes saludables, excelente visibilidad y una explosión de colorida vida marina. Es el escenario perfecto para una inmersión relajada, donde cada momento bajo el agua es una oportunidad para asombrarse con la belleza del Caribe colombiano. ¡Un verdadero paraíso submarino que te invita a la calma y la observación!',
  playacaSmDescriptionP2:
    'Con una profundidad máxima de aproximadamente 18 m / 60 ft, Playaca se distingue por sus aguas calmadas y corrientes mínimas, lo que garantiza una experiencia de buceo sumamente cómoda y segura. Su arrecife coralino, compuesto por una mezcla vibrante de corales duros y blandos, alberga una abundante variedad de peces de arrecife. Esta combinación de condiciones favorables y rica biodiversidad convierte a Playaca en un auténtico "biodiversity hotspot" y un lugar predilecto para la fotografía submarina y la observación detallada de la vida macro. La entrada al sitio se realiza cómodamente desde embarcación, permitiéndote disfrutar plenamente de este pintoresco y apacible rincón del Tayrona.',
  // ----- PhotoCredits -----
  playacaSmXXMainLogoAlt: 'Logo JustDiveCol',
  // playacaSmXXComplementaryLogoAlt: '',
  // playacaSmXXTextOverlay: '',
  playacaSmXXPhotoCredit: 'Créditos: XYZ',

  // ===== Punta Aguja - PNN Tayrona =====
  puntaAgujaSmName: 'Punta Aguja - PNN Tayrona',
  ...
  easyDifficultyKey: 'Fácil',
  mediumDifficultyKey: 'Medio',
  hardDifficultyKey: 'Difícil',
  expertDifficultyKey: 'Experto',

  // --- Translations for DIVE_TYPES (from diveSiteOptions.js) ---
  reefTypeKey: 'Arrecife',
  wreckTypeKey: 'Pecio',
  wallTypeKey: 'Pared',
  pinnacleTypeKey: 'Pináculo',
  cavernTypeKey: 'Caverna',
  caveTypeKey: 'Cueva',
  driftTypeKey: 'Deriva',
  muckTypeKey: 'Arenal',
  blueHoleTypeKey: 'Blue Hole',
  cenoteTypeKey: 'Cenote',
  freshwaterTypeKey: 'Agua Dulce',
  artificialReefTypeKey: 'Arrecife Artificial',

  // --- Translations for DIVE_CONDITIONS (from diveSiteOptions.js) ---
  currentConditionKey: 'Corriente',
  mildCurrentConditionKey: 'Corriente Leve',
  moderateCurrentConditionKey: 'Corriente Moderada',
  strongCurrentConditionKey: 'Corriente Fuerte',
  deepConditionKey: 'Profundo',
  visibilityConditionKey: 'Visibilidad', // Generic visibility label
  variableVisibilityConditionKey: 'Visibilidad Variable',
  goodVisibilityConditionKey: 'Buena Visibilidad',
  limitedVisibilityConditionKey: 'Visibilidad Limitada',
  thermoclineConditionKey: 'Termoclina',
  surgeConditionKey: 'Oleaje',
  surfaceConditionKey: 'Superficie', // Generic surface label
  roughSurfaceConditionKey: 'Superficie Agitada',
  calmSurfaceConditionKey: 'Superficie En Calma',
  entryConditionKey: 'Entrada', // Generic entry label
  boatEntryConditionKey: 'Entrada en Barco',
  shoreEntryConditionKey: 'Entrada desde la Orilla',
  nightConditionKey: 'Nocturno',

  // --- Translations for DIVE_TAG_CATEGORIES (from diveSiteOptions.js) ---
  marineLifeTagCategory: 'Vida Marina',
  diveCharacteristicsTagCategory: 'Características de Buceo',
  featuresTagCategory: 'Características',
  locationTagCategory: 'Ubicación',

  // --- Translations for DIVE_TAGS (from diveSiteOptions.js) ---
  // Marine Life
  sharksTag: 'tiburones',
  turtlesTag: 'tortugas',
  mantaRaysTag: 'mantarrayas',
  whaleSharksTag: 'tiburones ballena',
  nudibranchsTag: 'nudibranquios',
  macroLifeTag: 'vida macro',
  schoolingFishTag: 'cardúmenes de peces',
  barracudaTag: 'barracudas',
  octopusTag: 'pulpos',
  dolphinsTag: 'delfines',
  seahorsesTag: 'caballitos de mar',
  frogfishTag: 'pez rana',
  reefFishTag: 'peces de arrecife',
  pelagicsTag: 'pelágicos',

  // Dive Characteristics
  photographyTag: 'fotografía',
  nightDiveTag: 'buceo nocturno',
  driftDiveTag: 'buceo a la deriva',
  deepDiveTag: 'buceo profundo',
  technicalDiveTag: 'buceo técnico',
  beginnerFriendlyTag: 'apto para principiantes',
  advancedOnlyTag: 'solo avanzados',
  historicalTag: 'histórico',
  biodiversityHotspotTag: 'punto de biodiversidad',
  conservationAreaTag: 'área de conservación',
  coldWaterTag: 'agua fría',
  warmWaterTag: 'agua cálida',

  // Features
  swimThroughsTag: 'pasadizos',
  canyonsTag: 'cañones',
  cavesTag: 'cuevas',
  overhangsTag: 'salientes',
  softCoralsTag: 'corales blandos',
  hardCoralsTag: 'corales duros',
  anemonesTag: 'anémonas',

  // Location
  caribbeanTag: 'Caribe',
  pacificTag: 'Pacífico',
  redSeaTag: 'Mar Rojo',
  indianOceanTag: 'Océano Índico',
  tropicalTag: 'tropical',
  temperateTag: 'templado',
