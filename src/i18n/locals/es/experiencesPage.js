...
export default {
  ...
  expCatalogDestsTitle: 'Explora nuestros destinos listos para tu aventura',
  expCatalogOtherDestsTitle: ' Otros destinos',

  // Custom Trip CTA
  expCtaTitle: '¿No encuentras la experiencia submarina de tus sueños entre nuestras ofertas?',
  expCtaSubtitle:
