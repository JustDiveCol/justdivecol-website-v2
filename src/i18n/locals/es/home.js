...
export default {
  ...
  homeTestimonial1Quote:
    'La experiencia de buceo superó todas mis expectativas. El equipo de JustDiveCol es increíblemente profesional y apasionado. Me sentí seguro y libre en cada inmersión. ¡Una aventura que cambiará tu vida!',
  homeTestimonial1Name: 'María Fernanda R.',
  homeTestimonial1Origin: 'Bogotá, Colombia',
  homeTestimonial2Quote:
    'Siempre soñé con bucear, y JustDiveCol hizo ese sueño realidad de la manera más espectacular. La organización, la calidad del equipo y la calidez del instructor hicieron que todo fuera perfecto. ¡Ahora soy una buza certificada y feliz!',
  homeTestimonial2Name: 'Carlos S.',
  homeTestimonial2Origin: 'Ciudad de México, México',
  homeTestimonial3Quote:
    'Cada viaje con JustDiveCol es una nueva historia. Han sabido combinar la aventura extrema con un compromiso genuino por la conservación. La atención personalizada y los destinos elegidos son inigualables. ¡Altamente recomendados para cualquier buzo!',
