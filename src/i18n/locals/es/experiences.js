...
export default {
  ...
  paymentPlanStep1Name: '50% (Fecha Límite: 15 de agosto de 2025)',
  paymentPlanStep1Desc: 'Asegura tu cupo y recibe el material de estudio PADI.',

  paymentPlanStep2Name: '25% (Fecha Límite: 5 de septiembre de 2025)',
  ...
  expsmsept25ItineraryNote1:
    'Recomendamos encarecidamente programar tu vuelo de regreso para después del mediodía del último día, a fin de garantizar un margen de seguridad post-buceo adecuado (mínimo 18-24 horas sin volar después de la última inmersión).',
  ...
  expsmsept25GaleryImg1MainLogoAlt: 'Logo principal de JustDiveCol',
  // expsmsept25GaleryImg1ComplementaryLogoAlt: '',
  // expsmsept25GaleryImg1TextOverlay: '',
  expsmsept25GaleryImg1PhotoCredit: 'Créditos de la foto: XYZ',
