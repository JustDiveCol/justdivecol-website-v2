...
export default {
  ...
  aboutHistoryP1:
    'JustDiveCol nació de la profunda conexión entre amigos unidos por un amor incondicional al mar. Lo que comenzó como inmersiones recreativas, pronto evolucionó en una visión compartida: revelar la maravilla y la libertad ilimitada que solo el océano puede ofrecer.',
  aboutHistoryP2:
    'Desde la primera burbuja que exhalamos bajo el agua, supimos que la seguridad sería el pilar fundamental de cada aventura que emprenderíamos. Con un compromiso constante con el aprendizaje y un respeto absoluto por el ecosistema marino, hemos forjado experiencias que conectan el corazón y la mente con este extraordinario mundo acuático.',
  aboutHistoryP3:
  ...
  aboutTeamMember1Bio:
    'Para Camilo, el océano no es solo un destino, es un santuario de paz y emoción. Su profunda pasión lo llevó a fundar JustDiveCol, con el propósito de compartir este amor a través de experiencias seguras y llenas de aventura. Él es la prueba viviente de que la calma profunda y la adrenalina pueden coexistir en perfecta armonía bajo el agua.',
  aboutTeamMember1Fact1:
    'Ingeniero de sistemas durante el día; de noche, su desconexión perfecta es sumergirse en lo profundo del mar.',
  aboutTeamMember1Fact2:
    'Su encuentro más impactante fue cara a cara con un tiburón toro, una experiencia que reafirmó su inmenso respeto por la vida marina.',
  ...
  aboutTeamMember2Bio:
    'Para Alejandra, bucear es como volar lentamente a través de un universo oculto. Se deleita flotando entre vibrantes corales, dejándose llevar suavemente por las corrientes y descubriendo paisajes de otro mundo. Su misión es guiarte a valorar cada matiz de este vasto y asombroso océano.',
  aboutTeamMember2Fact1:
    'Su primera inmersión fue a los 12 años, y desde entonces, es una incansable luchadora por la limpieza de los océanos.',
  aboutTeamMember2Fact2:
    'Aunque su gran sueño es nadar junto a una ballena azul, por ahora, los encuentros con ballenas jorobadas le roban el aliento.',
  ...
  aboutCommitmentPoint1Desc:
    'Promovemos activamente prácticas de buceo de bajo impacto, colaboramos con proyectos globales de conservación y extraemos valiosos aprendizajes de cada inmersión para asegurar la salud de nuestros océanos.',
  aboutCommitmentPoint2Title: 'Seguridad sin concesiones',
  aboutCommitmentPoint2Desc:
    'Tu bienestar es nuestra máxima prioridad. Mantenemos estrictos protocolos de seguridad internacionales y utilizamos equipos de buceo de la más alta calidad para que disfrutes cada inmersión con total confianza y tranquilidad.',
  aboutCommitmentPoint3Title: 'Apoyo local y turismo responsable',
  aboutCommitmentPoint3Desc:
    'Trabajamos de la mano con comunidades y operadores locales para fomentar un modelo de turismo que impulse un desarrollo social y económico sostenible en cada destino que visitamos.',
};
