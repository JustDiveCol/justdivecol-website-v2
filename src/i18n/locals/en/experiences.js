...
export default {
  ...
  // Card 1
  expCard1Category: 'PADI Courses and Certifications',
  expCard1Title: 'Your Underwater Adventure Starts Here',

  // Card 2
  expCard2Category: 'Dive Trips and Exploration',
  expCard2Title: 'Destinations That Will Take Your Breath Away',

  // Card 3
  expCard3Category: 'Customized Experiences',
