...
export default {
  // Dive Site Specific Translations (from individual dive site data)
  puntaGranateName: 'Punta Granate',
  puntaGranateShortDescKey:
    'A vibrant reef with a dramatic wall drop-off, teeming with marine life.',
  puntaGranateFullDescKey:
    "Punta Granate is one of Santa Marta's most spectacular dive sites, known for its healthy coral formations and a stunning wall that descends to over 30 meters. Divers can expect to see schooling fish, moray eels, and occasional reef sharks. The currents can be moderate, making it an exciting drift dive for experienced divers. Visibility typically ranges from 15-25 meters.",
  puntaGranateReefAlt: 'Underwater view of Punta Granate reef',
  puntaGranateWallAlt: 'Punta Granate wall dive',
  // Add other dive site specific names, descriptions, and alt texts here as you create them
  tagangaBayName: 'Taganga Bay',
  tagangaBayShortDescKey:
    'Beginner-friendly reef with calm conditions, perfect for discovering marine life.',
  tagangaBayFullDescKey:
    "Taganga Bay is an excellent spot for new divers and refresher courses. It offers calm waters, good visibility, and a shallow reef full of colorful fish. It's a great place to get comfortable in the water and practice skills.",
  tagangaBayAlt: 'Underwater view of Taganga Bay reef',
