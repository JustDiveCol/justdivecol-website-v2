 ...
 */
export const experienciaSantaMartaNoviembre2025 = {
  // --- Metadata ---
  id: 'experiencia-santa-marta-nov-2025', // Unique identifier for the trip.
  status: 'published', // 'published' or 'draft'.
  destinationId: 'santa-marta', // Crucial link to the corresponding destination data file.
  type: 'trip', // Type of experience.
  nameKey: 'expsmnov25Name', // Translation key for the trip's name.
    ...
    items: [
      {
        ...
        valueKey: 'expsmnov25DetailValue1',
      },
      {
