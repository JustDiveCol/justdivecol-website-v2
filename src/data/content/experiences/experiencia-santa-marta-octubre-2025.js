 ...
 */
export const experienciaSantaMartaOctubre2025 = {
  // --- Metadata ---
  id: 'experiencia-santa-marta-oct-2025', // Unique identifier for the trip.
  status: 'published', // 'published' or 'draft'.
  destinationId: 'santa-marta', // Crucial link to the corresponding destination data file.
  type: 'trip', // Type of experience.
  nameKey: 'expsmoct25Name', // Translation key for the trip's name.
    ...
    items: [
      {
        ...
        valueKey: 'expsmoct25DetailValue1',
      },
      {
