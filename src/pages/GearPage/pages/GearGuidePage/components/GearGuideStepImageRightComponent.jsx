// src/pages/GearPage/pages/GearGuidePage/components/GearGuideStepImageRightComponent.jsx
...
const GearGuideStepImageRightComponent = ({
  anchorId,
  image,
  whatIsTitleKey,
  whatIsContentKey,
...
export default GearGuideStepImageRightComponent;
