...
const DestinationLayout = ({ destinationData, upcomingTrips }) => {
  ...
  return (
    ...
    >
      <HeaderComponent sectionData={destinationData.header} translationNS="destinations" />
      ...
      <div className="container mx-auto p-4 md:p-8 grid lg:grid-cols-3 gap-8">
        ...
        <main className="lg:col-span-2 space-y-16 lg:sticky top-24 h-fit">
          ...
          <GallerySection galleryData={destinationData.gallery} translationNS="destinations" />
        </main>

        {/* --- Sidebar column --- */}
        <aside className="lg:col-span-1 space-y-8 lg:sticky top-24 h-fit">
          <DetailsCard detailsData={destinationData.details} translationNS="destinations" />
          <ChecklistCard
            checklistData={{
